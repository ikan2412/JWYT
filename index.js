...
//
const BotName = 'Aby7X'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/kagaadaig'; // Nama Instagramlu cok
const whatsapplu = '+1 (831) 290-6051'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Aby7X`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Aby7X`)
})
