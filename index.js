...
//
const BotName = './barnacleboy26'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/syahrul.0125'; // Nama Instagramlu cok
const whatsapplu = '+62 895-0274-7353'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/GxeGGRtV1WHJtkbT0eLZpd'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/JiOavpDHezZATKv3LCMOx8'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @syahrul.0125`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @syahrul.0125`)
})
...
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik $help ya gan...' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik $help ya gan...' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik $help ya gan...' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik $help ya gan...' ,MessageType.text);
}
